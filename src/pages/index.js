...
//import '../assets/javascript/rev-slider.js';
/*import '../assets/javascript/plugins.js';
import '../assets/javascript/jquery-countTo.js';
import '../assets/javascript/jquery-ui.js';
import '../assets/javascript/jquery-fancybox.js';
import '../assets/javascript/flex-slider.min.js';
import '../assets/javascript/owl.carousel.min.js';
import '../assets/javascript/jquery.mCustomScrollbar.concat.min.js';
import '../assets/javascript/parallax.js';
import '../assets/javascript/jquery-isotope.js';
import '../assets/javascript/equalize.min.js';
                            ...
                            {({
                                ...
                                <Form onSubmit={() => handleSubmit(handleClick)} className="apply-now">
                                    ...
                                    <div className="btn-50 hv-border text-center">
                                        <button className="btn bg-clff5f60" disabled={!isValid} onClick={() => handleClick(values)}>
                                            Apply now
                                        </button>
                                    </div>
                                </Form>
